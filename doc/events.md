#События
Для возможности более гибкой работы с настройками в «Конструкторе» предусмотрена система событий. Название всех событий определены в классе `\Rover\Fadmin\Options` в константах, начинающихся на `EVENT__`. Подробнее о событиях вы можете почитать в [api по \Rover\Fadmin\Options](./doc/api/options.md#Константы)
